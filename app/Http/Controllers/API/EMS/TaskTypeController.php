...
use App\Services\EMS\TaskTypeService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class TaskTypeController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface {

	private $baseService;

	public function __construct() {
		$this->baseService = new TaskTypeService();
	}
