...
use App\Services\EMS\JobTypeService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class JobTypeController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface {

	private $baseService;

	public function __construct() {
		$this->baseService = new JobTypeService();
	}
