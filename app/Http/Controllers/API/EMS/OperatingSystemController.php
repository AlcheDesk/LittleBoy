...
use App\Services\EMS\OperatingSystemService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class OperatingSystemController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface {

	private $baseService;

	public function __construct() {
		$this->baseService = new OperatingSystemService();
	}
