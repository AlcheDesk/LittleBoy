...
use App\Services\EMS\ComponentService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class ComponentController extends MeowlomoBaseController implements MeowlomoUuidBaseControllerInterface {

	private $baseService;

	public function __construct() {
		$this->baseService = new ComponentService();
	}
