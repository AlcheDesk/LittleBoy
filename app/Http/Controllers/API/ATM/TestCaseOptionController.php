...
use App\Services\ATM\TestCaseOptionService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class TestCaseOptionController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new TestCaseOptionService();
    }
    ...
    // 关联接口
    public function getTestCaseByTestCaseOptionId(Request $request, $testCaseOptionId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getTestCaseByTestCaseOptionId($request, $testCaseOptionId);
