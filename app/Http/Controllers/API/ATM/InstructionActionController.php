...
use App\Services\ATM\InstructionActionService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class InstructionActionController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new InstructionActionService();
    }
    ...
    public function getElementTypeByInstructionActionId(Request $request, $InstructionActionId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getElementTypeByInstructionActionId($request, $InstructionActionId);
    ...
    public function getInstructionOptionByInstructionActionId(Request $request, $id)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        // get the Model objects from mapper layer
        $jsonStringResponse = $this->baseService->getInstructionOptionByInstructionActionId($request, $id);
