...
use App\Services\ATM\DriverPropertyPredefinedValueService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class DriverPropertyPredefinedValueController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new DriverPropertyPredefinedValueService();
    }
