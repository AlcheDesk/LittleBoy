...
use App\Services\ATM\ApiSchemaService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class ApiSchemaController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new ApiSchemaService();
    }
    ...
    public function getProjectByApiSchemaId(Request $request, $apiSchemaId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getProjectByApiSchemaId($request, $apiSchemaId);
