...
use App\Services\ATM\SystemRequirementService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class SystemRequirementController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new SystemRequirementService();
    }
    ...
    // 关联接口
    public function getTestCaseBySystemRequirementId(Request $request, $systemRequirementId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getTestCaseBySystemRequirementId($request, $systemRequirementId);
