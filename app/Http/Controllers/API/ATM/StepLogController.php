...
use App\Services\ATM\StepLogService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class StepLogController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new StepLogService();
    }
    ...
    // 关联接口
    public function getInstructionResultByStepLogId(Request $request, $stepLogId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getInstructionResultByStepLogId($request, $stepLogId);
