...
use App\Services\ATM\CopyService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;
use App\Http\Controllers\API\MeowlomoBaseController;

class CopyController extends MeowlomoBaseController
{
    ...
    {
        $this->baseService = new CopyService();
    }
    ...
    public function copyProject(Request $request)
    {
        ...
        $jsonStringResponse = $this->baseService->copyProject($request);
    ...
    // 复制testCase
    public function copyTestCase(Request $request)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        // get the Model objects from mapper layer
        $jsonStringResponse = $this->baseService->copyTestCase($request);
    ...
    // 复制instruction
    public function copyInstructionInTestCase(Request $request, $testCaseId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->copyInstructionInTestCase($request, $testCaseId);
    ...
    // 复制testCaseOverwrite
    public function copyTestCaseOverwrite(Request $request)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        // get the Model objects from mapper layer
        $jsonStringResponse = $this->baseService->copyTestCaseOverwrite($request);
