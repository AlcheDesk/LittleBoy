...
use App\Services\ATM\InstructionOptionService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class InstructionOptionController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new InstructionOptionService();
    }
    ...
    // 关联接口
    public function getInstructionByInstructionOptionId(Request $request, $id)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getInstructionByInstructionOptionId($request, $id);
