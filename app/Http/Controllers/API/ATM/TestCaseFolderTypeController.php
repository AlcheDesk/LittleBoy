...
use App\Services\ATM\TestCaseFolderTypeService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class TestCaseFolderTypeController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new TestCaseFolderTypeService();
    }
    ...
    // 关联接口
    public function getTestCaseFolderByTestCaseFolderTypeId(Request $request, $testCaseFolderTypeId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getTestCaseFolderByTestCaseFolderTypeId($request, $testCaseFolderTypeId);
