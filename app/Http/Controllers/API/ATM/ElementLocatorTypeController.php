...
use App\Services\ATM\ElementLocatorTypeService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class ElementLocatorTypeController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new ElementLocatorTypeService();
    }
    ...
    // 关联接口
    public function getElementTypeByElementLocatorTypeId(Request $request, $elementLocatorTypeId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getElementTypeByElementLocatorTypeId($request, $elementLocatorTypeId);
