...
use App\Services\ATM\EmailNotificationTargetService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class EmailNotificationTargetController extends MeowlomoBaseController
{
    ...
    {
        $this->baseService = new EmailNotificationTargetService();
    }
