...
use App\Services\ATM\InstructionOverwriteService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class InstructionOverwriteController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new InstructionOverwriteService();
    }
    ...
    // 关联接口
    public function getTestCaseOverwriteByInstructionOverwriteId(Request $request, $instructionOverwriteId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getTestCaseOverwriteByInstructionOverwriteId($request, $instructionOverwriteId);
