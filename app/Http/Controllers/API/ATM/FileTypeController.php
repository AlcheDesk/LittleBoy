...
use App\Services\ATM\FileTypeService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class FileTypeController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new FileTypeService();
    }
    ...
    // 关联接口
    public function getFileByFileTypeId(Request $request, $fileTypeId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getFileByFileTypeId($request, $fileTypeId);
