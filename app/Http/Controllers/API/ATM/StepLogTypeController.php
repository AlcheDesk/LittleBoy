...
use App\Services\ATM\StepLogTypeService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class StepLogTypeController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new StepLogTypeService();
    }
    ...
    public function getStepLogByStepLogTypeId(Request $request, $stepLogTypeId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getStepLogByStepLogTypeId($request, $stepLogTypeId);
