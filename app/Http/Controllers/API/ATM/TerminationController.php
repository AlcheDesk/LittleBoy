...
use App\Services\ATM\TerminationService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class TerminationController extends MeowlomoBaseController
{
    ...
    {
        $this->baseService = new TerminationService();
    }

    public function terminationTestCaseRunById(Request $request, $id)
    {
        ...
        $jsonStringResponse = $this->baseService->terminationTestCaseRunById($request, $id);
    ...
    public function terminationRunSetResultRunById(Request $request, $id)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->terminationRunSetResultRunById($request, $id);
