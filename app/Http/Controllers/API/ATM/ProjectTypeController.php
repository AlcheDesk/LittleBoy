...
use App\Services\ATM\ProjectTypeService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class ProjectTypeController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new ProjectTypeService();
    }
    ...
    // 关联接口
    public function getProjectByProjectTypeId(Request $request, $projectTypeId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getProjectByProjectTypeId($request, $projectTypeId);
