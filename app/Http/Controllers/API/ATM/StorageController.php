...
use App\Services\ATM\StorageService;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class StorageController extends MeowlomoBaseController implements MeowlomoBaseControllerInterface
{
    ...
    {
        $this->baseService = new StorageService();
    }
    ...
    // 关联接口
    public function getTestCaseByStorageId(Request $request, $storageId)
    {
        $bodyContent = $request->getContent();
        // check the body is json
        json_decode($bodyContent);
        ...
        $jsonStringResponse = $this->baseService->getTestCaseByStorageId($request, $storageId);
