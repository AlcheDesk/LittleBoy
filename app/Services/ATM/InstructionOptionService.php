...
use App\Mappers\ATM\InstructionOptionMapper;
use App\Services\Service;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class InstructionOptionService implements Service
{
    ...
    {
        $this->mapper = new InstructionOptionMapper();
    }
    ...
    public function getInstructionByInstructionOptionId(Request $request, $id) : string
    {
        $jsonStringResponse = $this->mapper->getInstructionByInstructionOptionId($this->mapper->parse_query($request->getQueryString()), $id);
        Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
        return $jsonStringResponse;
    }
