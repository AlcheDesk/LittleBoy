...
use App\Mappers\ATM\FileTypeMapper;
use App\Services\Service;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class FileTypeService implements Service
{
    ...
    {
        $this->mapper = new FileTypeMapper();
    }
     ...
     *
     * @SWG\Delete(
     * path="/api/fileTypes/{id}",
     * tags={"fileTypes resources"},
     * summary="删除单个FileType",
     ...
     *
     * @SWG\Get(
     * path="/api/fileTypes/{fileTypeId}/files",
     * tags={"fileTypes resources"},
     * summary="getFileByFileTypeId",
     * operationId="getFileByFileTypeId",
     * produces={"application/json"},
     * @SWG\Parameter(
     * name="fileTypeId ",
     * type="integer",
     ...
     */
    // 关联接口
    public function getFileByFileTypeId(Request $request, $fileTypeId) : string
    {
        $jsonStringResponse = $this->mapper->getFileByFileTypeId($this->mapper->parse_query($request->getQueryString()), $fileTypeId);
        Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
        return $jsonStringResponse;
    }
}
