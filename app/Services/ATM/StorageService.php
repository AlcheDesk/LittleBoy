...
use App\Mappers\ATM\StorageMapper;
...
class StorageService implements Service
{
     ...
     *
     * @SWG\Get(
     * path="/api/storages/{storageId}/testCases",
     * tags={"storages resources"},
     * summary="{storageId}/testCases",
     * operationId="getTestCaseByStorageId",
     * produces={"application/json"},
     * @SWG\Parameter(
     * name="storageId",
     * type="integer",
     ...
     */
    // 关联接口
    public function getTestCaseByStorageId(Request $request, $storageId) : string
    {
        $jsonStringResponse = $this->mapper->getTestCaseByStorageId($this->mapper->parse_query($request->getQueryString()), $storageId);
        Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
        return $jsonStringResponse;
    }
}
