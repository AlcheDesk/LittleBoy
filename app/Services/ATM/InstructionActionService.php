...
use App\Mappers\ATM\InstructionActionMapper;
use App\Services\Service;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class InstructionActionService implements Service
{
    ...
    {
        $this->mapper = new InstructionActionMapper();
    }
    ...
    public function getElementTypeByInstructionActionId(Request $request, $InstructionActionId) : string
    {
        $jsonStringResponse = $this->mapper->getElementTypeByInstructionActionId($this->mapper->parse_query($request->getQueryString()), $InstructionActionId);
        Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
        return $jsonStringResponse;
    }
    ...
    public function getInstructionOptionByInstructionActionId(Request $request, $id) : string
    {
        // get the Model objects from mapper layer
        $jsonStringResponse = $this->mapper->getInstructionOptionByInstructionActionId($this->mapper->parse_query($request->getQueryString()), $id);
        Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
        return $jsonStringResponse;
    }
