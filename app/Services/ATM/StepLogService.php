...
use App\Mappers\ATM\StepLogMapper;
use App\Services\Service;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class StepLogService implements Service
{
     ...
     *
     * @SWG\Get(
     * path="/api/stepLogs/{stepLogId}/instructionResults",
     * tags={"stepLogs resources"},
     * summary="读取StepLog关联的InstructionResult",
     * operationId="getInstructionResultsByStepLogId",
     * produces={"application/json"},
     * @SWG\Parameter(
     * name="stepLogId",
     * type="integer",
     ...
     */
    // 关联接口
    public function getInstructionResultByStepLogId(Request $request, $stepLogId) : string
    {
        $jsonStringResponse = $this->mapper->getInstructionResultByStepLogId($this->mapper->parse_query($request->getQueryString()), $stepLogId);
        Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
        return $jsonStringResponse;
    }
}
