...
use App\Mappers\ATM\TestCaseFolderTypeMapper;
use App\Services\Service;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class TestCaseFolderTypeService implements Service
{
    ...
    {
        $this->mapper = new TestCaseFolderTypeMapper();
    }

    /**
     *
     * @SWG\Delete(
     * path="/api/testCaseFolderTypes",
     * tags={"testCaseFolderTypes resources"},
     * summary="删除TestCaseFolderType",
     ...
     *
     * @SWG\Delete(
     * path="/api/testCaseFolderTypes/{id}",
     * tags={"testCaseFolderTypes resources"},
     * summary="删除单个TestCaseFolderType",
     ...
     * path="/api/testCaseFolderTypes/{id}",
     * tags={"testCaseFolderTypes resources"},
     * summary="读取单个TestCaseFolderType",
     ...
     * path="/api/testCaseFolderTypes",
     * tags={"testCaseFolderTypes resources"},
     * summary="更新单个TestCaseFolderType",
     * operationId="update",
     * produces={"application/json"},
     * @SWG\Parameter(
     * name="body",
     ...
     * path="/api/testCaseFolderTypes",
     * tags={"testCaseFolderTypes resources"},
     * summary="替换或添加TestCaseFolderType",
     * operationId="replace",
     * produces={"application/json"},
     * @SWG\Parameter(
     * name="body",
     ...
     *
     * @SWG\Get(
     * path="/api/testCaseFolderTypes/{testCaseFolderTypeId}/testCaseFolders",
     * tags={"testCaseFolderTypes resources"},
     * summary="读取TestCaseFolderType关联的TestCaseFolder",
     * operationId="getTestCaseFolderByTestCaseFolderTypeId",
     * produces={"application/json"},
     * @SWG\Parameter(
     * name="testCaseFolderTypeId",
     * type="integer",
     * in="path",
     * required=true
     * ),
     ...
     */
    // 关联接口
    public function getTestCaseFolderByTestCaseFolderTypeId(Request $request, $testCaseFolderTypeId) : string
    {
        $jsonStringResponse = $this->mapper->getTestCaseFolderByTestCaseFolderTypeId($this->mapper->parse_query($request->getQueryString()), $testCaseFolderTypeId);
        Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
        return $jsonStringResponse;
    }
}
