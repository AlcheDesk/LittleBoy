...
use App\Mappers\ATM\SystemRequirementPacksMapper;
use App\Services\Service;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class SystemRequirementPacksService implements Service
{
    ...
    {
        $this->mapper = new SystemRequirementPacksMapper();
    }
     ...
     */
    // 关联接口
    public function getSystemRequirementsBySystemRequirementPackId(Request $request, $systemRequirementPackId) : string
    {
        $jsonStringResponse = $this->mapper->getSystemRequirementsBySystemRequirementPackId($this->mapper->parse_query($request->getQueryString()), $systemRequirementPackId);
        Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
        return $jsonStringResponse;
    }
    public function deleteSystemRequirementsBySystemRequirementPackId($request, $systemRequirementPackId) : string
    {
        $jsonStringResponse = $this->mapper->deleteSystemRequirementsBySystemRequirementPackId($this->mapper->parse_query($request->getQueryString()), $systemRequirementPackId);
        Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
        return $jsonStringResponse;
    }
    public function insertSystemRequirementsBySystemRequirementPackId(Request $request, $systemRequirementPackId) : string
    {
        $jsonStringResponse = $this->mapper->insertSystemRequirementsBySystemRequirementPackId($request->getContent(), $systemRequirementPackId);
        Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
        return $jsonStringResponse;
    }
    public function replaceSystemRequirementsBySystemRequirementPackId(Request $request, $systemRequirementPackId) : string
    {
        $jsonStringResponse = $this->mapper->replaceSystemRequirementsBySystemRequirementPackId($request->getContent(), $systemRequirementPackId);
        Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
        return $jsonStringResponse;
    }
}
