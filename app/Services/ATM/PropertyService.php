...
use App\Mappers\ATM\PropertyMapper;
use App\Services\Service;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class PropertyService implements Service
{
     ...
     *
     * @SWG\Delete(
     * path="/api/propertys/{id}",
     * tags={"propertys resources"},
     * summary="删除单个Property",
