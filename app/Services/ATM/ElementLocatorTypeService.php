...
use App\Mappers\ATM\ElementLocatorTypeMapper;
use App\Services\Service;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class ElementLocatorTypeService implements Service
{
    ...
    {
        $this->mapper = new ElementLocatorTypeMapper();
    }
    ...
    // 关联接口
    public function getElementTypeByElementLocatorTypeId(Request $request, $elementLocatorTypeId) : string
    {
        $jsonStringResponse = $this->mapper->getElementTypeByElementLocatorTypeId($this->mapper->parse_query($request->getQueryString()), $elementLocatorTypeId);
        Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
        return $jsonStringResponse;
    }
}
