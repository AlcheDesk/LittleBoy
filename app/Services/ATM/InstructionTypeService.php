...
use App\Mappers\ATM\InstructionTypeMapper;
use App\Services\Service;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class InstructionTypeService implements Service {

	private $mapper;

	public function __construct() {
		$this->mapper = new InstructionTypeMapper();
	}

	/**
	 *
	 * @SWG\Delete(
	 * path="/api/instructionTypes",
	 * tags={"instructionTypes resources"},
	 * summary="删除InstructionType",
	 ...
	 *
	 * @SWG\Delete(
	 * path="/api/instructionTypes/{id}",
	 * tags={"instructionTypes resources"},
	 * summary="删除单个InstructionType",
	 ...
	 *
	 * @SWG\Get(
	 * path="/api/instructionTypes/{instructionTypeId}/instructions",
	 * tags={"instructionTypes resources"},
	 * summary="读取InstructionType关联的Instruction",
	 * operationId="getInstructionByInstructionTypeId",
	 * produces={"application/json"},
	 * @SWG\Parameter(
	 ...
	 */
	// 关联接口
	public function getInstructionByInstructionTypeId(Request $request, $id) : string {
		$jsonStringResponse = $this->mapper->getInstructionByInstructionTypeId($this->mapper->parse_query($request->getQueryString()), $id);
		Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
		return $jsonStringResponse;
	}

	public function getElementTypeByInstructionTypeId(Request $request, $id) : string {
		$jsonStringResponse = $this->mapper->getElementTypeByInstructionTypeId($this->mapper->parse_query($request->getQueryString()), $id);
		Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
		return $jsonStringResponse;
	}
	
	public function getInstructionActionByInstructionTypeId(Request $request, $id) : string {
	    $jsonStringResponse = $this->mapper->getInstructionActionByInstructionTypeId($this->mapper->parse_query($request->getQueryString()), $id);
	    Log::debug('Service layer ' . __CLASS__ . ' ' . __FUNCTION__ . ' return ' . var_export($jsonStringResponse, true));
	    return $jsonStringResponse;
	}
}
