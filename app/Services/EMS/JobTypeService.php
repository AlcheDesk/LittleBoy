...
use App\Mappers\EMS\JobTypeMapper;
use App\Services\Service;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;
use App\Services\Utils\RedisUtils\EMS\JobTypeRedisUtilService;

class JobTypeService implements Service {
    ...
    {
        $this->mapper = new JobTypeMapper();
        $this->groupRedisUtilService = new JobTypeRedisUtilService();
    }
