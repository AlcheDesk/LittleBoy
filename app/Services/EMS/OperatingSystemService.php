...
use App\Mappers\EMS\OperatingSystemMapper;
use App\Services\Service;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;
use App\Services\Utils\RedisUtils\EMS\OperatingSystemRedisUtilService;

class OperatingSystemService implements Service {
    ...
    {
        $this->mapper = new OperatingSystemMapper();
        $this->groupRedisUtilService = new OperatingSystemRedisUtilService();
    }
