...
use App\Mappers\EMS\TaskTypeMapper;
use App\Services\Service;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;
use App\Services\Utils\RedisUtils\EMS\TaskTypeRedisUtilService;

class TaskTypeService implements Service {
    ...
    {
        $this->mapper = new TaskTypeMapper();
        $this->groupRedisUtilService = new TaskTypeRedisUtilService();
    }
