...
class StatusMapper extends EMSBaseMapper implements BaseMapper
{
    ...
    public function countByOptions(array $options = [], $concurrentRequest = false): string
    {
        $options[] = 'count';
        // generate the url
        $url = $this->generateUrl("/api/statuss", $this->build_query($options));
        // return as request
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/statuss/" . $id);
        if ($concurrentRequest) {
            return new Request('DELETE', $url);
        }
        // sent to the data source server
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/statuss");
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/statuss/" . $id, $this->build_query($options));
        // return as request
        if ($concurrentRequest) {
            return new Request('GET', $url);
        }
