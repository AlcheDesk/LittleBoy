...
class SystemRequirementMapper extends ATMBaseMapper implements BaseMapper
{
    ...
    public function countByOptions(array $options = [], $concurrentRequest = false): string
    {
        $options[] = 'count';
        // generate the url
        $url = $this->generateUrl("/api/systemRequirements", $this->build_query($options));
        // return as request
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/systemRequirements/" . $id);
        if ($concurrentRequest) {
            return new Request('DELETE', $url);
        }
        // sent to the data source server
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/systemRequirements");
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/systemRequirements/" . $id, $this->build_query($options));
        // return as request
        if ($concurrentRequest) {
            return new Request('GET', $url);
        }
    ...
    // ===== systemRequirement testCase link start =====
    public function getTestCaseBySystemRequirementId(array $options = [], $systemRequirementId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/systemRequirements/" . $systemRequirementId . "/testCases", $this->build_query($options));
        // return as request
        if ($concurrentRequest) {
            return new Request('GET', $url);
        }
    ...
    // ===== systemRequirement testCase link end =====
}
