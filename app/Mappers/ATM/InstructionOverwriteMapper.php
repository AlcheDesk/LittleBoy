...
class InstructionOverwriteMapper extends ATMBaseMapper implements BaseMapper
{
    ...
    public function countByOptions(array $options = [], $concurrentRequest = false): string
    {
        $options[] = 'count';
        // generate the url
        $url = $this->generateUrl("/api/instructionOverwrites", $this->build_query($options));
        // return as request
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/instructionOverwrites/" . $id);
        if ($concurrentRequest) {
            return new Request('DELETE', $url);
        }
        // sent to the data source server
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/instructionOverwrites");
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/instructionOverwrites/" . $id, $this->build_query($options));
        // return as request
        if ($concurrentRequest) {
            return new Request('GET', $url);
        }
    ...
    public function getTestCaseOverwriteByInstructionOverwriteId(array $options = [], $instructionOverwriteId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/instructionOverwrites/" . $instructionOverwriteId . "/testCaseOverwrites", $this->build_query($options));
        // return as request
        if ($concurrentRequest) {
            return new Request('GET', $url);
        }
