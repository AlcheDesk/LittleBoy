...
class DriverPackMapper extends ATMBaseMapper implements BaseMapper
{
    ...
    public function countByOptions(array $options = [], $concurrentRequest = false): string
    {
        $options[] = 'count';
        // generate the url
        $url = $this->generateUrl("/api/driverPacks", $this->build_query($options));
        // return as request
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/driverPacks/" . $id);
        if ($concurrentRequest) {
            return new Request('DELETE', $url);
        }
        // sent to the data source server
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/driverPacks");
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/driverPacks/" . $id, $this->build_query($options));
        // return as request
        if ($concurrentRequest) {
            return new Request('GET', $url);
        }
    ...
    public function deleteDriverByDriverPackId(array $options = [], $driverPackId, $concurrentRequest = false): string
    {
        // generate the link url
        $url = $this->generateUrl("/api/driverPacks/" . $driverPackId . "/drivers", $this->build_query($options));
        if ($concurrentRequest) {
            return new Request('DELETE', $url);
        }
        // sent to the data source server
    ...
    public function insertDriverAndLinkByDriverPackId(string $jsonStringBody, $driverPackId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/driverPacks/" . $driverPackId . "/drivers");
    ...
    public function getDriverByDriverPackId(array $options = [], $driverPackId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/driverPacks/" . $driverPackId . "/drivers", $this->build_query($options));
        // return as request
    ...
    public function updateDriverByDriverPackId(string $jsonStringBody, $driverPackId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/driverPacks/" . $driverPackId . "/drivers");
    ...
    public function replaceOrInsertDriverByDriverPackId(string $jsonStringBody, $driverPackId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/driverPacks/" . $driverPackId . "/drivers");
