...
class NotificationMapper extends ATMBaseMapper
{

    public function selectByOptions(array $options = [], $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/notifications/", $this->build_query($options));
        // return as request
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/notifications/" . $id);
        if ($concurrentRequest) {
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/notifications");
