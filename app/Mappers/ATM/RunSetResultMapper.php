...
class RunSetResultMapper extends ATMBaseMapper implements BaseMapper
{
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/runSetResults/" . $id);
        if ($concurrentRequest) {
            return new Request('DELETE', $url);
        }
        // sent to the data source server
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/runSetResults");
    ...
    public function deleteRunFromRunSetResult(array $options = [], $runSetResultId, $concurrentRequest = false): string
    {
        // generate the link url
        $url = $this->generateUrl("/api/runSetResults/" . $runSetResultId . "/runs", $this->build_query($options));
        if ($concurrentRequest) {
            return new Request('DELETE', $url);
        }
        // sent to the data source server
    ...
    public function unlinkRunFromRunSetResult(array $options = [], $runSetResultId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/runSetResults/" . $runSetResultId . "/runs", $this->build_query($options));
        if ($concurrentRequest) {
    ...
    public function insertRunAndLinkToRunSetResult(string $jsonStringBody, $runSetResultId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/runSetResults/" . $runSetResultId . "/runs");
    ...
    public function getRunByRunSetResultId(array $options = [], $runSetResultId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/runSetResults/" . $runSetResultId . "/runs", $this->build_query($options));
        // return as request
    ...
    public function updateRunFromRunSetResult(string $jsonStringBody, $runSetResultId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/runSetResults/" . $runSetResultId . "/runs");
    ...
    public function replaceOrInsertRunByRunSetResult(string $jsonStringBody, $runSetResultId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/runSetResults/" . $runSetResultId . "/runs");
    ...
    public function linkRunToRunSetResult(string $jsonStringBody, $runSetResultId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/runSetResults/" . $runSetResultId . "/runs");
        if ($concurrentRequest) {
    ...
    public function getRunExecutionInfoByRunSetResultId(array $options = [], $id, $concurrentRequest = false): string{
        $options[] = 'count';
        // generate the url
        $url = $this->generateUrl("/api/runSetResults/" . $id . "/runExecutionInfo/", $this->build_query($options));
        // return as request
        if ($concurrentRequest) {
            return new Request('GET', $url);
        }
