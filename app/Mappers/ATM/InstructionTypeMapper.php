...
class InstructionTypeMapper extends ATMBaseMapper implements BaseMapper {

	public function countByOptions(array $options = [], $concurrentRequest = false): string{
		$options[] = 'count';
		// generate the url
		$url = $this->generateUrl("/api/instructionTypes", $this->build_query($options));
		// return as request
	...
	public function deleteById($id, $concurrentRequest = false): string{
		// generate the url
		$url = $this->generateUrl("/api/instructionTypes/" . $id);
		if ($concurrentRequest) {
			return new Request('DELETE', $url);
		}
		// sent to the data source server
	...
	public function insert(string $jsonStringBody, $concurrentRequest = false): string{
		// generate the url
		$url = $this->generateUrl("/api/instructionTypes");
	...
	public function selectById(array $options = [], $id, $concurrentRequest = false): string{
		// generate the url
		$url = $this->generateUrl("/api/instructionTypes/" . $id, $this->build_query($options));
		// return as request
		if ($concurrentRequest) {
			return new Request('GET', $url);
		}
	...
	public function getInstructionByInstructionTypeId(array $options = [], $instructionTypeId, $concurrentRequest = false): string{
		// generate the url
		$url = $this->generateUrl("/api/instructionTypes/" . $instructionTypeId . "/instructions", $this->build_query($options));
		// return as request
		if ($concurrentRequest) {
			return new Request('GET', $url);
		}
	...
	public function getElementTypeByInstructionTypeId(array $options = [], $instructionTypeId, $concurrentRequest = false): string{
		// generate the url
		$url = $this->generateUrl("/api/instructionTypes/" . $instructionTypeId . "/elementTypes", $this->build_query($options));
		// return as request
		if ($concurrentRequest) {
			return new Request('GET', $url);
		}
	...
	public function getInstructionActionByInstructionTypeId(array $options = [], $instructionTypeId, $concurrentRequest = false): string{
	    // generate the url
	    $url = $this->generateUrl("/api/instructionTypes/" . $instructionTypeId . "/instructionActions", $this->build_query($options));
	    // return as request
	    if ($concurrentRequest) {
	        return new Request('GET', $url);
	    }
