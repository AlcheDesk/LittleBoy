...
class RunExecutionInfoMapper extends ATMBaseMapper {

    //runExecutionInfo
    public function getRunExecutionInfo(array $options = [], $concurrentRequest = false): string{
        $options[] = 'count';
        // generate the url
        $url = $this->generateUrl("/api/runExecutionInfo", $this->build_query($options));
        // return as request
    ...
    public function getRunExecutionInfoById(array $options = [], $id, $concurrentRequest = false): string{
        $options[] = 'count';
        // generate the url
