...
class TestCaseExecutionInfoMapper extends ATMBaseMapper {

    //testCaseExecutionInfo
    public function getTestCaseExecutionInfo(array $options = [], $concurrentRequest = false): string{
        $options[] = 'count';
        // generate the url
        $url = $this->generateUrl("/api/testCaseExecutionInfo", $this->build_query($options));
        // return as request
    ...
    public function getTestCaseExecutionInfoById(array $options = [], $id, $concurrentRequest = false): string{
        $options[] = 'count';
        // generate the url
