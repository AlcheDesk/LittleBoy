...
class SectionMapper extends ATMBaseMapper implements BaseMapper
{
    ...
    public function countByOptions(array $options = [], $concurrentRequest = false): string
    {
        $options[] = 'count';
        // generate the url
        $url = $this->generateUrl("/api/sections", $this->build_query($options));
        // return as request
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/sections/" . $id);
        if ($concurrentRequest) {
            return new Request('DELETE', $url);
        }
        // sent to the data source server
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/sections");
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/sections/" . $id, $this->build_query($options));
        // return as request
        if ($concurrentRequest) {
            return new Request('GET', $url);
        }
    ...
    public function getApplicationBySectionId(array $options = [], $sectionId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/sections/" . $sectionId . "/applications", $this->build_query($options));
        // return as request
        if ($concurrentRequest) {
            return new Request('GET', $url);
        }
    ...
    public function deleteElementFromSection(array $options = [], $sectionId, $concurrentRequest = false): string
    {
        // generate the link url
        $url = $this->generateUrl("/api/sections/" . $sectionId . "/elements", $this->build_query($options));
        if ($concurrentRequest) {
            return new Request('DELETE', $url);
        }
        // sent to the data source server
    ...
    public function insertElementAndLinkToSection(string $jsonStringBody, $sectionId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/sections/" . $sectionId . "/elements");
    ...
    public function getElementBySectionId(array $options = [], $sectionId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/sections/" . $sectionId . "/elements", $this->build_query($options));
        // return as request
    ...
    public function updateElementFromSection(string $jsonStringBody, $sectionId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/sections/" . $sectionId . "/elements");
    ...
    public function replaceOrInsertElementBySection(string $jsonStringBody, $sectionId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/sections/" . $sectionId . "/elements");
