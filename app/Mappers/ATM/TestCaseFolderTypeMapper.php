...
class TestCaseFolderTypeMapper extends ATMBaseMapper implements BaseMapper
{
    ...
    public function countByOptions(array $options = [], $concurrentRequest = false): string
    {
        $options[] = 'count';
        // generate the url
        $url = $this->generateUrl("/api/testCaseFolderTypes", $this->build_query($options));
        // return as request
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/testCaseFolderTypes/" . $id);
        if ($concurrentRequest) {
            return new Request('DELETE', $url);
        }
        // sent to the data source server
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/testCaseFolderTypes");
    ...
    {
        // generate the url
        $url = $this->generateUrl("/api/testCaseFolderTypes/" . $id, $this->build_query($options));
        // return as request
        if ($concurrentRequest) {
            return new Request('GET', $url);
        }
    ...
    // ===== testCaseFolderType testCaseFolder link start =====
    public function getTestCaseFolderByTestCaseFolderTypeId(array $options = [], $testCaseFolderTypeId, $concurrentRequest = false): string
    {
        // generate the url
        $url = $this->generateUrl("/api/testCaseFolderTypes/" . $testCaseFolderTypeId . "/testCaseFolders", $this->build_query($options));
        // return as request
        if ($concurrentRequest) {
            return new Request('GET', $url);
        }
    ...
    // ===== testCaseFolderType testCaseFolder link end =====
}
