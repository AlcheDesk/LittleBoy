 ...
 * Generated for Laravel 5.8.7 on 2019-03-26 07:34:30.
 *
...
namespace Clarkeash\Doorman\Facades { 
    ...
    class Doorman {
         ...
         * @static 
         */ 
        public static function redeem($code, $email = null)
        {
                        /** @var \Clarkeash\Doorman\Doorman $instance */
                        return $instance->redeem($code, $email);
        }
         ...
         * @static 
         */ 
        public static function check($code, $email = null)
        {
                        /** @var \Clarkeash\Doorman\Doorman $instance */
                        return $instance->check($code, $email);
        }
...
namespace Yansongda\LaravelPay\Facades { 
    ...
    class Pay {
        ...
        {
                        /** @var \Yansongda\Pay\Gateways\Alipay $instance */
                        return $instance->find($order, $type, $transfer);
        }
...
namespace  { 
    ...
    class Doorman extends \Clarkeash\Doorman\Facades\Doorman {}
