      ...
      <project-tool-bar>
        <div slot="breadcrumb">
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>{{ lang.breadcrumb.api_element }}</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      navigationToAddApiElement() {
        ...
        window.location.href = '/atm/TestSetting/Project/' + this.projectId + '/ApiElementAdd?page=' + currentPage + '+' + currentSize;
      },
      ...
      ApiElementEdit(row) {
        ...
        var currentPage = parseInt(str.split('&')[0].split('=')[1].split('+')[0]);
        var currentSize = parseInt(str.split('&')[0].split('=')[1].split('+')[1]);
        window.location.href = '/atm/TestSetting/Project/' + this.projectId + '/ApiElementEdit?page=' + currentPage + '+' + currentSize;
      },
