    ...
    <project-tool-bar>
      <div slot="breadcrumb">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>
            <a style="font-weight: 500;" :href="'/atm/TestSetting/Project/' + projectId + '/ApiElement/?page=1+25'">{{ lang.breadcrumb.api_element }}</a>
          </el-breadcrumb-item>
    ...
    addApiInstruction(formname) {
      this.$refs[formname].validate((valid) => {
        if (valid) {
          ...
          window.location.href = '/atm/TestSetting/Project/' + this.projectId + '/ApiElement?page=' + currentPage + '+' + currentSize;
