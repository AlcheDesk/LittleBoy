<template>
  <div>
    <el-row :gutter="20" style="height: 100px;">
      <el-col :span="8" class="test_setting instruction_result_toorbar_item">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>
            <a style="font-weight: 500;" :href="'/atm/DebugResult/Project/' + projectId + '/TestCase/' + testCaseId + '/Runs/?page=1+25'">{{ lang.breadcrumb.case_result }}</a>
          </el-breadcrumb-item>
          <el-breadcrumb-item>{{ lang.breadcrumb.step_result }}</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
      <el-col :span="5" class="name instruction_result_toorbar_item">
        <el-popover
          ref="name"
          placement="top"
          trigger="click">
          <div>NO.{{projectTestCaseResultMessage.id}} <br/> {{projectTestCaseResultMessage.name}}/{{projectTestCaseRunResultMessage.testCaseOverwriteName}}</div>
        </el-popover>
        <div class="text_ellipsis" v-popover:name>NO.{{projectTestCaseResultMessage.id}} <br/> {{projectTestCaseResultMessage.name}}/{{projectTestCaseRunResultMessage.testCaseOverwriteName}}</div>
      </el-col>
      <el-col :span="7" class="instruction_result_toorbar_item">
        <el-popover
          ref="createdAt"
          placement="top"
          trigger="click">
          <div>{{ lang.table.create_at }}: {{projectTestCaseResultMessage.createdAt}}</div>
        </el-popover>
        <div class="text_ellipsis" v-popover:createdAt>{{ lang.table.create_at }}: {{projectTestCaseResultMessage.createdAt}}</div>
      </el-col>
    </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      viewApiInstaructionResultInfo() {
        window.location.href = '/atm/DebugResult/Project/' + this.projectId + '/TestCase/' + this.testCaseId + '/Runs/' + this.runId + '/Instruction/' + this.instructionId + '/ApiLog';
      },
