    ...
    <project-tool-bar :messageInfo="projectTestCaseResultMessage">
      <div slot="breadcrumb">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>
            <a style="font-weight: 500;" :href="'/atm/DebugResult/Project/' + projectId + '/TestCase/' + testCaseId + '/Runs/' + runId + '/Instruction/?page=1+25'">{{ lang.breadcrumb.step_result }}</a>
          </el-breadcrumb-item>
      ...
      <el-row :gutter="20" class="query_row">
        ...
        <el-col :span="12">
          ...
          <el-row class="query_content api_text">
            <el-col :span="24">
              <el-input type="textarea" disabled :autosize="{ minRows: 5}"></el-input>
            </el-col>
          </el-row>
        </el-col>
      </el-row>
    ...
    <el-row class="result_return">
      <el-col :span="10" class="result_col border_right">
        <template v-if="headerOrJsonPath == 'HEADERS'">
          <div class="response_block" v-for="key in responseHeaders">
            <div :title="key.split(':')[0]" class="response_key">
              {{key.split(':')[0]}}:
            </div>
            <div :title="key.split(':')[1]" class="response_key">
              {{key.split(':')[1]}}
            </div>
          </div>
        </template>
  ...
  export default {
    ...
    methods: {
      ...
      NavigatorToInstruction() {
        ...
        window.location.href = '/atm/TestSetting/Project/' + this.projectId + '/TestCase/' + this.testCaseId + '/ApiTest?page=1+25';
    ...
    mounted() {
      ...
      this.responseHeaders = row.outputParameter.responseHeaders;
