...
<head>
    ...
    @font-face {
        font-family: wts11;
        src: url('{{ base_path() }}/storage/fonts/wts11.ttf') format('truetype');
    }
...
<div class="content">
    ...
    <div> 利用 Dompdf 将 html（包含中文）转 pdf</div>


    <hr>

    <p>我是你爸爸爸爸爸爸爸爸阿萨德发包第三次包是大VSDK包多厉害包安委办包就是大V开酒吧苏打绿一是大V局
         DVDis大V金币深V偶数都会供ID包实地VB一包三等功各爸爸爸</p>
